...
def parse_args():
    ...
    p.add_argument('--plotseparate', action='store_true')
...
if __name__ == "__main__":
    ...
    if not os.path.exists(outdir):
        os.mkdir(outdir)
    myplotter = Plotter(args.indir, outdir, args.master_csv_file, show_plots=args.show_plots, plotseparate=args.plotseparate)
    ...
    #myplotter.plot_var(var="BTD2_conf")
    myplotter.plot_var(var="VolcanicAsh_BTD3")
