...
DICT_CUT_CONSTRAINT = {
    'mtg_medva_==_4': [{'variables':["BTD2_conf"], 'operators':['<='], 'values':['df_c4']},
    ...
    'mtg_medva_==_3': [{'variables':["BTD2_conf"], 'operators':['<='], 'values':[-0.1]},
    ...
    'mtg_medva_==_5': [{'variables':["BTD2_conf"], 'operators':['<='], 'values':[-0.1]},
                 {'variables':["BTD2_conf"], 'operators':['>'], 'values':['df_c3']},
                 {'variables':["VolcanicAsh_BTD3"], 'operators':['<='], 'values':['df_BTD3thresh']},
    ...
    'mtg_medva_==_6': [{'variables':["BTD2_conf"], 'operators':['<='], 'values':['df_c3']},
    ...
    'mtg_medva_>_0': [{'variables':["PreFilter_VA_Confidence"], 'operators':['>'], 'values':[0]},
    ...
    'mtg_medva_==_7': [{'variables':["BTD2_conf"], 'operators':['<='], 'values':['df_c1']},
